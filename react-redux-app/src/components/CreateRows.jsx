  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '1rem' }}>
        <button onClick={() => handleGenerate(1)}>Criar 1 linha</button>
        <button onClick={() => handleGenerate(100)}>Criar 100 linhas</button>
        <button onClick={() => handleGenerate(1000)}>Criar 1000 linhas</button>
        <button onClick={() => handleGenerate(10000)}>Criar 10000 linhas</button>
      </div>
