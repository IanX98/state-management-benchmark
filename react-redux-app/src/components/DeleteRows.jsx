...
const DeleteRows = () => {
  ...
  return (
    <div>
      ...
      <button onClick={() => handleDelete(1)}>Deletar 1 linha</button>
      <button onClick={() => handleDelete(100)}>Deletar 100 linhas</button>
      <button onClick={() => handleDelete(1000)}>Deletar 1000 linhas</button>
      <button onClick={() => handleDelete(10000)}>Deletar 10000 linhas</button>
